    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gray-50 text-gray-800 overflow-hidden">
      <div className="w-full h-20 bg-opacity-30 border-b gap-x-5 bg-white fixed top-0 z-[50] flex items-center backdrop-blur-sm justify-between lg:px-32 px-20">
        <div className="flex gap-x-4 items-center">
          ...
          <h1 className="text-3xl font-semibold">Sync Board</h1>
        </div>
      ...
      <main className="text-center px-6 relative z-10 max-w-3xl mx-auto">
        <h1 className="text-6xl font-extrabold mb-6">Welcome to Sync Board</h1>
        ...
        <div className="flex justify-center gap-4">
          <button
            onClick={() => router.push("/documents")}
            className="bg-indigo-500 font-semibold tracking-wide bg-opacity-50 hover:text-white text-slate-700 px-6 py-3 rounded-lg shadow-md hover:bg-indigo-700 transition hover:bg-opacity-70"
          >
            Start Writing
          </button>
          <button
      ...
      <div className="absolute inset-0 flex flex-wrap gap-4 opacity-30">
